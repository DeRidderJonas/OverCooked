...
public:
	UberMaterial();
	virtual ~UberMaterial() override = default;
	...
	void SetFresnelColor(const DirectX::XMFLOAT4& color);
...
private:
	...
	void InitVectorVariable(ID3DX11EffectVectorVariable** vectorVariable, const std::string& variableName);
	void InitScalarVariable(ID3DX11EffectScalarVariable** scalarVariable, const std::string& variableName);
	void InitTextureVariable(ID3DX11EffectShaderResourceVariable** textureVariable, const std::string& variableName);
};

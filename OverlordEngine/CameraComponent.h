...
public:
	...
	DirectX::XMFLOAT2 GetScreenPositionScreenSpace(const DirectX::XMFLOAT3& worldPosition) const;
	DirectX::XMFLOAT2 GetScreenPosition(const DirectX::XMFLOAT3& worldPosition) const;
